...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.3.188-blue?style=for-the-badge" alt="Version">
  <img src="https://img.shields.io/badge/license-MIT-green?style=for-the-badge" alt="License">
  <img src="https://img.shields.io/badge/tests-1560-passing?style=for-the-badge&color=brightgreen" alt="Tests">
...
- HTTP 插件系统，YAML 模板
- HTTP API 发现端点 — OpenAI 兼容 `/v1/models`、`/v1/capabilities` 与非流式文本 `/v1/chat/completions`，方便外部 UI 探测能力
...
- [x] HTTP API 模型/能力发现端点 + 文本 Chat Completions
