...
- **记忆**：持久化记忆 + FTS5 全文检索
- **效率**：待办清单、支持 Profile 路由、工作日志、事件轨迹与诊断的 Kanban 看板、定时任务
...
- HTTP 插件系统，YAML 模板
- Skills Hub — 社区技能市场
- 隔离 Profile — 通过 `hakimi profile` 和网关 `/profile` 管理命名工作区
