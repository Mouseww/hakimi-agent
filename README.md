...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.3.230-blue?style=for-the-badge" alt="Version">
  <img src="https://img.shields.io/badge/license-MIT-green?style=for-the-badge" alt="License">
  <img src="https://img.shields.io/badge/tests-1727-passing?style=for-the-badge&color=brightgreen" alt="Tests">
...
- Gateway `/usage` shows last-turn token/cost/rate-limit data, OpenRouter `/credits` plus `/key` quota/usage, and Anthropic OAuth account windows without exposing credentials
...
- [x] OpenRouter and Anthropic account usage display in gateway `/usage`
- [ ] WASM plugin runtime
- [ ] Web dashboard
