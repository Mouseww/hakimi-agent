...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.3.228-blue?style=for-the-badge" alt="Version">
  <img src="https://img.shields.io/badge/license-MIT-green?style=for-the-badge" alt="License">
  <img src="https://img.shields.io/badge/tests-1718-passing?style=for-the-badge&color=brightgreen" alt="Tests">
...
- Gateway `/usage` shows last-turn token/cost/rate-limit data and, for OpenRouter profiles, live `/credits` plus `/key` account quota and usage totals without exposing credentials
...
- [x] OpenRouter account usage and API-key quota display in gateway `/usage`
- [ ] WASM plugin runtime
- [ ] Web dashboard
