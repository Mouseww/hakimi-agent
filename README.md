...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.3.207-blue?style=for-the-badge" alt="Version">
  <img src="https://img.shields.io/badge/license-MIT-green?style=for-the-badge" alt="License">
  <img src="https://img.shields.io/badge/tests-1625-passing?style=for-the-badge&color=brightgreen" alt="Tests">
...
- HTTP API discovery — OpenAI-compatible `/v1/models`, `/v1/capabilities`, `/v1/skills`, `/v1/toolsets`, non-streaming text `/v1/chat/completions`, `/v1/responses` with SQLite-backed `previous_response_id` chaining plus completed SSE snapshots for `stream=true`, pollable and cancellable `/v1/runs` with live lifecycle SSE events, and session messages/search discovery for external UI feature detection
