...
- HTTP API discovery — OpenAI-compatible `/v1/models`, `/v1/capabilities`, `/v1/skills`, `/v1/toolsets`, non-streaming text `/v1/chat/completions`, and non-streaming `/v1/responses` with `previous_response_id` chaining for external UI feature detection
