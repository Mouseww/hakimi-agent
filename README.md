...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.3.235-blue?style=for-the-badge" alt="Version">
...
- Gateway `/usage` shows last-turn token/cost/rate-limit data, best-effort OpenRouter-compatible `/v1/models` live pricing, OpenRouter `/credits` plus `/key` quota/usage, Anthropic OAuth account windows, and Codex usage windows without exposing credentials
