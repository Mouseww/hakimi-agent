...
- Gateway `/usage` shows last-turn token/cost/rate-limit data, OpenRouter `/credits` plus `/key` quota/usage, Anthropic OAuth account windows, and Codex usage windows without exposing credentials
