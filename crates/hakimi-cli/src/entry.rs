...
impl GatewayStreamUiState {
    ...
    fn render_pending(
        ...
        if self.needs_new_message {
            ...
            self.last_rendered_at_boundary = active_text.clone();
            tracing::info!(
...
mod tests {
    use super::{
        ...
        format_gateway_tool_result, format_gateway_update_notification,
        ...
        top_level_mcp_response, tui_executable_name, tui_frontend_candidates, update_shim_paths,
